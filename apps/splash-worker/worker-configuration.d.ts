/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.splash.jsonc apps/splash-worker/worker-configuration.d.ts` (hash: 4244ca629f6011b823f8b11dd959b509)

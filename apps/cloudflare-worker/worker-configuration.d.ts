/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.application.jsonc apps/cloudflare-worker/worker-configuration.d.ts` (hash: f29acfe7650c56d1751659def6bab4ae)

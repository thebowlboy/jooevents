/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.application.jsonc apps/cloudflare-worker/worker-configuration.d.ts` (hash: f7dfbf931f4b7d78e716d9084fa3b5a1)

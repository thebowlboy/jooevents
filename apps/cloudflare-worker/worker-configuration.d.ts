/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.application.jsonc apps/cloudflare-worker/worker-configuration.d.ts` (hash: 9f2ed2b3563d074e9901f76dd4b588c8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JOOEVENTS_DEPLOYMENT_ENVIRONMENT" | "JOOEVENTS_D1_RELEASE_FLOOR" | "JOOEVENTS_AUTH_RUNTIME_ENABLED" | "JOOEVENTS_APPLICATION_RUNTIME_ENABLED" | "JOOEVENTS_FILES_MAX_UPLOAD_BYTES_SPEAKER" | "JOOEVENTS_FILES_MAX_UPLOAD_BYTES_ORGANIZER" | "JOOEVENTS_FILES_MAX_TOTAL_BYTES_PER_SPEAKER_EVENT">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.application.jsonc apps/cloudflare-worker/worker-configuration.d.ts` (hash: 357cd013e425ba7920c66150160cd07e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JOOEVENTS_DEPLOYMENT_ENVIRONMENT" | "JOOEVENTS_D1_RELEASE_FLOOR" | "JOOEVENTS_AUTH_RUNTIME_ENABLED" | "JOOEVENTS_APPLICATION_RUNTIME_ENABLED">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.application.jsonc apps/cloudflare-worker/worker-configuration.d.ts` (hash: 742afa2215cb74737870858d2b7e96be)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JOOEVENTS_DEPLOYMENT_ENVIRONMENT" | "JOOEVENTS_D1_RELEASE_FLOOR" | "JOOEVENTS_AUTH_RUNTIME_ENABLED">> {}
}

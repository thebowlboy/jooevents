...
- SQLite compatibility floor: `sqlite-e2-s12`, migration runner version 2, terminal
  migration sequence 12. This floor identifier is a database compatibility contract,

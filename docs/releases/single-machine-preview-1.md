...
- SQLite compatibility floor: `sqlite-e2-s11`, migration runner version 2, terminal
  migration sequence 11. This floor identifier is a database compatibility contract,

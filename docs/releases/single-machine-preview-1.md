...
- SQLite compatibility floor: `sqlite-e2-s7`, migration runner version 2, terminal
  migration sequence 7. This floor identifier is a database compatibility contract,

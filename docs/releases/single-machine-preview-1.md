...
- SQLite compatibility floor: `sqlite-e2-s6`, migration runner version 2, terminal
  migration sequence 6. This floor identifier is a database compatibility contract,

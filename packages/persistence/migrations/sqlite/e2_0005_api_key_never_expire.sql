...
DROP TRIGGER api_key_permission_scopes_no_update;
DROP TRIGGER api_key_permission_scopes_no_delete;
DROP TRIGGER api_key_event_scopes_no_update;
DROP TRIGGER api_key_event_scopes_no_delete;
DROP TRIGGER api_keys_identity_immutable;
DROP TRIGGER api_keys_transition_guard;
DROP TRIGGER api_keys_no_delete;
DROP INDEX api_keys_workspace_owner_created;
DROP INDEX api_keys_workspace_standing_expiry;

ALTER TABLE api_key_permission_scopes RENAME TO api_key_permission_scopes_e2_0004;
ALTER TABLE api_key_event_scopes RENAME TO api_key_event_scopes_e2_0004;
ALTER TABLE api_keys RENAME TO api_keys_e2_0004;
...
INSERT INTO api_keys (
  ...
  last_used_at_ms, standing, revoked_at_ms, revoked_by_user_id, revoke_reason,
...
INSERT INTO api_key_permission_scopes(api_key_id, permission_id)
SELECT api_key_id, permission_id FROM api_key_permission_scopes_e2_0004;
...
INSERT INTO api_key_event_scopes(api_key_id, event_id)
SELECT api_key_id, event_id FROM api_key_event_scopes_e2_0004;

DROP TABLE api_key_permission_scopes_e2_0004;
DROP TABLE api_key_event_scopes_e2_0004;
DROP TABLE api_keys_e2_0004;
